...
import com.example.shivambhardwaj.shitube.databinding.LanscapeHomeRecyclerViewBinding;
...
public class LandscapeHomeAdapter extends RecyclerView.Adapter<LandscapeHomeAdapter.viewHolder> {
    ArrayList<VideoModel> list;
    Context context;
    private DownloadManager downloadManager;

    public LandscapeHomeAdapter(ArrayList<VideoModel> list, Context context) {
        this.list = list;
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.lanscape_home_recycler_view, parent, false);
...
//                            Toast.makeText(context, "Downloading", Toast.LENGTH_SHORT).show();
    ...
    public class viewHolder extends RecyclerView.ViewHolder {
        LanscapeHomeRecyclerViewBinding binding;

        public viewHolder(@NonNull View itemView) {
            super(itemView);
            binding = LanscapeHomeRecyclerViewBinding.bind(itemView);
        }
    }
}
