...
public class BottomVideoSuggetionAdapter extends RecyclerView.Adapter<BottomVideoSuggetionAdapter.viewHolder> {
    ArrayList<VideoModel> list;
    Context context;

    public BottomVideoSuggetionAdapter(ArrayList<VideoModel> list, Context context) {
        this.list = list;
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.bottom_videos_suggetion, parent, false);
...
//        });
    ...
    public class viewHolder extends RecyclerView.ViewHolder {
        BottomVideosSuggetionBinding binding;

        public viewHolder(@NonNull View itemView) {
            super(itemView);
            binding = BottomVideosSuggetionBinding.bind(itemView);
        }
    }
}
